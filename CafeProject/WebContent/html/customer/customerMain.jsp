	...
	<body>
		<div id="customer_left">
			<table id="list">
				...
				<tr>
					<td class="clist"><input class="check" type="radio" name="check" value="${c.customer_tel}"></td>
					<td class="clist">${c.customer_name}</td>
					<td class="clist">${c.customer_tel}</td>
					<td class="clist">${c.point}</td>
				</tr>
				</c:forEach>
			</table>
		</div>
